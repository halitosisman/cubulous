...
fn setup(
    ...
    let cube_handle = asset_server.load("examples/cube/cube.gltf#Mesh0/Primitive0");
    let sphere_handle = asset_server.load("examples/sphere/sphere.gltf#Mesh0/Primitive0");
    ...
    // blocking
    // let _scenes: Vec<HandleUntyped> = asset_server.load_folder("assets/examples/monkey").unwrap();
    //
    // // Then any asset in the folder can be accessed like this:
    // let monkey_handle = asset_server.get_handle("examples/monkey/Monkey.gltf#Mesh0/Primitive0");
